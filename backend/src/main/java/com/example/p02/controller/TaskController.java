...
public class TaskController {
    ...
    @GetMapping("/userproject/{projectId}/{userId}")
    public ResponseEntity<List<Task>> getTasksByProjectIdANDUserId(@PathVariable Long projectId, Long userId) {
        List<Task> tasks = taskService.getTasksByProjectUserId(projectId, userId);
        return ResponseEntity.ok(tasks);
    }
